...
pdf(file.path(f1_outdir, "naive_top_markers_viridiscols.pdf"), width = 14, height = 4)
...
plt <- plot_feature(atcells, feature = "res.1.6", 
                 label_text = T, 
                 label_color = "Black", label_size = 2,
                 .cols = many_cols) 
...
mat <- mat[, c(td_cell_types, "Injured Type II")]
mat <- t(scale(t(mat)))
...
subset_ae2_injured <- filter(plt1$data, sample_type == "Injured AT-II")
