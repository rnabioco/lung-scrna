...
plt <- plot_grid(plotlist = plts, ncol = 1, nrow = 5)

save_plot(file.path(f2_outdir, "tsne_naive_injured_by_sample_type",
                    "no_labels",        "tsne_cell_cycle_arrest_injured_only.pdf"), 
          plt,
          ncol = 1,
          nrow = 5,
          base_height = 3.75, 
...
save_plot(file.path(f3_outdir, "igfbp
                    2_tsne_smaller_dots.pdf"), plt,  base_aspect_ratio = 1.33)
